...
function Sidebar() {
  ...
  return (
    <aside className="w-64 px-4 py-8" style={{ background: '#FFE6E6 ' }}>
      <p className=" text-black text-3xl px-6 py-4 whitespace-nowrap border-b font-bold mb-4 border-gray-900">MY SIDEBAR</p>
      {NavLinkFunction()}
    </aside>
  );
}
